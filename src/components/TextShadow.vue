  ...
  <div class="row" style="justify-content: space-between">
    <div class="col-xs-12 col-sm-12 col-md-6">
      <div class="no-scroll-area">
        <q-input label="Color" outlined v-model="textShadow_color" class="mb-10">
          <template v-slot:append>
            <div class="show-color" :style="{ backgroundColor: textShadow_color }"></div>
            <q-popup-proxy cover transition-show="scale" transition-hide="scale">
              <q-color v-model="textShadow_color" no-header-tabs :palette="colorPalette" />
            </q-popup-proxy>
          </template>
        </q-input>
        <div class="outlined-slider mb-10">
          <div class="slider-label">
            <span>Horizontal Offset</span><span>{{ textShadow_horizontal_offset }} px </span>
          </div>
          <q-slider
        ...
        <div class="outlined-slider mb-10">
          <div class="slider-label">
            <span>Vertical Offset</span><span>{{ textShadow_vertical_offset }} px </span>
          </div>
          <q-slider
    ...
    <div class="col-xs-12 col-md-5 q-gutter-y-lg">
      <div class="preview-box">
        <div class="text-shadow-preview" :style="textShadowPreview">Text Shadow</div>
      </div>
      <div class="code-box">
        {{ textShadowCode }}
      </div>
