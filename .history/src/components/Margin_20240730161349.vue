    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
      <q-scroll-area style="height: 56vh">
        <div style="margin: 0 1rem">
          ...
          />
          <div
            v-if="margin_type == 'Same on all sides'"
            class="same-margin-items"
          >
          ...
          <div
            class="different-margin-items"
            v-if="margin_type == 'Different on all sides'"
          >
  ...
  setup(props, ctx) {
    ...
    const marginPreview = computed(() => {
      if (margin_type.value == "Same on all sides") {
        return {
          margin: !margin_auto.value
            ? `${margin.value}${margin_unitType.value}`
            : `auto`,
        };
      } else {
        return {
    ...
    const marginCode = computed(() => {
      ...
      if (margin_type.value == "Same on all sides") {
        if (
          (margin.value && margin_unitType.value) ||
          marginPreview.value.margin === "auto"
        ) {
