    ...
    <div class="col-md-6 col-sm-12 col-xs-12">
      <q-scroll-area style="height: 56vh">
        <div style="padding: 0 1rem">
          ...
          <div
            class="different-border-items"
            v-if="radius_type == 'Different on all sides'"
          >
...
export default {
  ...
  setup(props, ctx) {
    ...
    const isFilledTopLeft = computed(() => {
      return (
        radius_top_left.value !== "" && radius_top_left_unitType.value !== ""
      );
    });

    const isFilledTopRight = computed(() => {
      return (
        radius_top_right.value !== "" && radius_top_right_unitType.value !== ""
      );
    });
