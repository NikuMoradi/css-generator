...
<template>
  <q-btn @click="isPopupVisible = true" color="red-11">Style component</q-btn>
  <q-dialog v-model="isPopupVisible" full-width full-height>
    <q-card style="overflow: hidden; min-width: 320px">
      <q-toolbar>
        <q-toolbar-title class="text-span">Style</q-toolbar-title>
        <q-btn flat dense icon="fa fa-close" @click="isPopupVisible = false" />
      </q-toolbar>
      <q-card-section
        :style="
          $q.screen.gt.md
            ? 'height: 83%; padding-top: 0;'
            : 'height: 81%; padding-top: 0;'
        "
        class="scroll"
      >
        <q-tabs
          align="justify"
          outside-arrows
          class="activeTab bg-primary text-white shadow-2"
        >
          ...
          <q-btn-dropdown auto-close stretch flat label="Transition">
            <q-list>
              <q-item clickable @click="activeTab = 'transition'">
        ...
        <div v-show="activeTab === 'border'" class="container">
          <Border
            @borderEmit="handleEmits"
            :borderProp="categorizedProperties.borderProp"
          />
        </div>
        ...
        <div v-show="activeTab === 'outline'" class="container">
          <Outline
            @outlineEmit="handleEmits"
            :outlineProp="categorizedProperties.outlineProp"
          />
        </div>
        ...
        <div v-show="activeTab === 'margin'" class="container">
          <Margin
            @marginEmit="handleEmits"
            :marginProp="categorizedProperties.marginProp"
          />
        </div>
        <div v-show="activeTab === 'padding'" class="container">
          <Padding
            @paddingEmit="handleEmits"
            :paddingProp="categorizedProperties.paddingProp"
          />
        </div>
        <div v-show="activeTab === 'size'" class="container">
          <Size
            @sizeEmit="handleEmits"
            :sizeProp="categorizedProperties.sizeProp"
          />
        </div>
        <div v-show="activeTab === 'display'" class="container">
          <Display
            @displayEmit="handleEmits"
            :displayProp="categorizedProperties.displayProp"
          />
        </div>
        <div v-show="activeTab === 'position'" class="container">
          <Position
            @positionEmit="handleEmits"
            :positionProp="categorizedProperties.positionProp"
          />
        </div>
        <div v-show="activeTab === 'overflow'" class="container">
          <Overflow
            @overflowEmit="handleEmits"
            :overflowProp="categorizedProperties.overflowProp"
          />
        </div>
        <div v-show="activeTab === 'columns'" class="container">
          <Columns
            @columnsEmit="handleEmits"
            :columnsProp="categorizedProperties.columnsProp"
          />
        </div>
        ...
        <div v-show="activeTab === 'rotate'" class="container">
          <Rotate
            @rotateEmit="handleEmits"
            :rotateProp="categorizedProperties.rotateProp"
          />
        </div>
        <div v-show="activeTab === 'scale'" class="container">
          <Scale
            @scaleEmit="handleEmits"
            :scaleProp="categorizedProperties.scaleProp"
          />
        </div>
        <div v-show="activeTab === 'skew'" class="container">
          <Skew
            @skewEmit="handleEmits"
            :skewProp="categorizedProperties.skewProp"
          />
        </div>
        ...
        <div v-show="activeTab === 'opacity'" class="container">
          <Opacity
            @opacityEmit="handleEmits"
            :opacityProp="categorizedProperties.opacityProp"
          />
        </div>
        ...
        <div v-show="activeTab === 'transition'" class="container">
          <TN
            @transitionEmit="handleEmits"
            :transitionProp="categorizedProperties.transitionProp"
          />
        </div>
        ...
        <div v-show="activeTab === 'cursor'" class="container">
          <Cursor
            @cursorEmit="handleEmits"
            :cursorProp="categorizedProperties.cursorProp"
          />
        </div>
      </q-card-section>
...
export default {
  ...
  setup(props, ctx) {
    ...
    const objectToString = () => {
      let cssString = "";
      for (const [key, value] of Object.entries(cssObject.value)) {
        cssString += value;
      }
      return `{\n${cssString}}`;
    };
    ...
    function moveProperty(property) {
      ...
      switch (key.trim()) {
        ...
        case "transform":
          if (
            value.match(
              /rotateX\(\d+deg\)\s*rotateY\(\d+deg\)\s*rotateZ\(\d+deg\)/
            )
          ) {
...
import Background from "src/components/css/Background.vue";
import Border from "src/components/css/Border.vue";
import BorderRadius from "src/components/css/BorderRadius.vue";
import BoxShadow from "src/components/css/BoxShadow.vue";
import Opacity from "src/components/css/Opacity.vue";
import Outline from "src/components/css/Outline.vue";
import Overflow from "src/components/css/Overflow.vue";
import Size from "src/components/css/Size.vue";
import ImageEnhancements from "src/components/css/ImageEnhancements.vue";
import ImageShadow from "src/components/css/ImageShadow.vue";
import Columns from "src/components/css/Columns.vue";
import Display from "src/components/css/Display.vue";
import Visibility from "src/components/css/Visibility.vue";
import ListStyle from "src/components/css/ListStyle.vue";
import TextFormatting from "src/components/css/TextFormatting.vue";
import TextShadow from "src/components/css/TextShadow.vue";
import Perspective from "src/components/css/Perspective.vue";
import Rotate from "src/components/css/Rotate.vue";
import Scale from "src/components/css/Scale.vue";
import Skew from "src/components/css/Skew.vue";
import Translate from "src/components/css/Translate.vue";
import TN from "src/components/css/Transition.vue";
import Cursor from "src/components/css/Cursor.vue";
import Padding from "src/components/css/Padding.vue";
import Margin from "src/components/css/Margin.vue";
import Position from "src/components/css/Position.vue";
import { ref, computed, watch, reactive, toRaw, onMounted, provide } from "vue";
</script>
